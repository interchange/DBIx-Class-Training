...
Now if places_visited\_count is already cached via the with\_places_visited\_count
...
with\_places_visited\_count method on the resultset. From a performance viewpoint
...
on a User object from a resultset that has had with\_places_visited\_count
previously called on it then when you subsequently call places_visited\_count on
