...
This is not a relationship but a relationship bridge which defines an
...
stored in the column. This allows an application to switch from (say) crypt
to blowfish whilst still working with the old hashes.
