...
Many components exist for the Schema class and also for Result 
...
\begin{frame}{ResultSet Components}
\begin{itemize}
\item create a parent ResultSet class that all of our ResultSet classes inherit from
\item set this parent ResultSet class as the default ResultSet class in our Schema class
\item make sure all custom ResultSet classes do actually inherit from this
  class :)
\end{itemize}
\end{frame}

\paragraph{Schema Class}
\begin{frame}[fragile]{Schema Class}
\begin{lstlisting}
package TravelDance::Schema;
...
\paragraph{Parent Class}
\begin{frame}[fragile]{Parent Class}
\begin{lstlisting}
...
\paragraph{Custom ResultSet Class}
\begin{frame}[fragile]{Custom ResultSet Class}
\begin{lstlisting}
